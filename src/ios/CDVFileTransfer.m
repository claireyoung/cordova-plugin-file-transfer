...
@synthesize callbackId, connection = _connection, source, target, responseData, responseHeaders, command, bytesTransfered, bytesExpected, direction, responseCode, objectId, targetFileHandle, filePlugin, percentTransfered;
...
- (void)updateProgress
{
    if (self.direction == CDV_TRANSFER_DOWNLOAD) {
        ...
        [downloadProgress setObject:[NSNumber numberWithInteger:self.percentTransfered] forKey:@"percent"];
